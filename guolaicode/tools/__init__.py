...
from guolaicode.tools.base import Tool
...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None) -> ToolRegistry:
    ...
    from guolaicode.tools.edit_file import EditFile
    from guolaicode.tools.file_state_cache import FileStateCache
    from guolaicode.tools.glob import Glob
    from guolaicode.tools.grep import Grep
