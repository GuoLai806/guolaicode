...
if TYPE_CHECKING:
    ...
    from guolaicode.client import LLMClient
...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from guolaicode.agents.fork import ForkError, build_forked_messages
        from guolaicode.agents.parser import AgentDef
        from guolaicode.agents.tool_filter import resolve_agent_tools
        from guolaicode.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from guolaicode.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from guolaicode.agents.fork import ForkError, build_forked_messages
        from guolaicode.agents.parser import AgentDef
        from guolaicode.agents.tool_filter import build_teammate_tools
        from guolaicode.agent import Agent as AgentClass
        from guolaicode.conversation import ConversationManager
        from guolaicode.permissions import (
            DangerousCommandDetector,
        ...
        from guolaicode.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from guolaicode.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from guolaicode.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from guolaicode.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from guolaicode.client import create_client
        from guolaicode.config import ProviderConfig
