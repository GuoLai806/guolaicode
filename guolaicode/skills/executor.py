...
from guolaicode.skills.parser import SkillDef, substitute_arguments
from guolaicode.tools import ToolRegistry

if TYPE_CHECKING:
    from guolaicode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from guolaicode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
