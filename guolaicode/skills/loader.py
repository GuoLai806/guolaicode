...
from guolaicode.skills.parser import SkillDef, SkillParseError, parse_frontmatter, parse_skill_file

log = logging.getLogger(__name__)

PROJECT_SKILLS_DIR = ".guolaicode/skills"
USER_SKILLS_DIR = "~/.guolaicode/skills"
    ...
    def _load_builtins(self) -> list[SkillDef]:
        ...
        for resource in builtins_pkg.iterdir():
            ...
            try:
                ...
                from guolaicode.skills.parser import _validate_meta
