...
from guolaicode.teams.mailbox import Mailbox, create_message
...
from guolaicode.teams.progress import TeammateProgress
from guolaicode.teams.registry import AgentNameRegistry
from guolaicode.teams.shared_task import SharedTaskStore
from guolaicode.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from guolaicode.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
