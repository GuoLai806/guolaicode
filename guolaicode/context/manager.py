...
from guolaicode.serialization import build_messages
...
SESSION_SUBDIR = ".guolaicode/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from guolaicode.tools.base import StreamEnd, StreamEvent, TextDelta
