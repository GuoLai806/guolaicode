...
PROJECT_AGENTS_DIR = ".guolaicode/agents"
USER_AGENTS_DIR = "~/.guolaicode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("guolaicode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from guolaicode.agents.parser import parse_frontmatter, _validate_agent_meta
