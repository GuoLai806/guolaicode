...
def build_teammate_tools(
    ...
    from guolaicode.tools.send_message import SendMessageTool
    from guolaicode.tools.task_create import TaskCreateTool
    from guolaicode.tools.task_get import TaskGetTool
    from guolaicode.tools.task_list import TaskListTool
    from guolaicode.tools.task_update import TaskUpdateTool
